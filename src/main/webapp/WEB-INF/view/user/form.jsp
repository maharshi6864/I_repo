...
<meta charset="utf-8" />
<title>Form Validation | Skote - Admin & Dashboard Template</title>
						...
						<div class="col-xl-6">
							<div class="card">
								<div class="card-body">
									...
									<p class="card-title-desc">Provide valuable, actionable
										feedback to your users with HTML5 form validation–available in
										all our supported browsers.</p>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="mb-3">
													...
													<select class="form-select" id="validationCustom03"
														required>
											...
											<div class="col-md-4">
												<div class="mb-3">
													...
													<input type="text" class="form-control"
														id="validationCustom04" placeholder="City" required>
											...
											<div class="col-md-4">
												<div class="mb-3 position-relative">
													<label for="validationTooltip01" class="form-label">First
														name</label> <input type="text" class="form-control"
														id="validationTooltip01" placeholder="First name"
														value="Mark" required>
											...
											<div class="col-md-4">
												<div class="mb-3 position-relative">
													<label for="validationTooltip02" class="form-label">Last
														name</label> <input type="text" class="form-control"
														id="validationTooltip02" placeholder="Last name"
														value="Otto" required>
													<div class="valid-tooltip">Looks good!</div>
												</div>
											</div>
						...
						<div class="col-xl-6">
							<div class="card">
								<div class="card-body">
									...
									<p class="card-title-desc">Parsley is a javascript form
									...
									<form class="custom-validation" action="#">
										<div class="mb-3">
											<label class="form-label">Required</label> <input type="text"
