                                    ...
                                    <div class="w-100" style="user-select: none;">
                                        <div class="card">
                                            <div class="card-body">
                                                    ...
                                                    <div class="row mb-1">
                                                        <div class="col-xl-7 col-sm-6">
                                                            <div class="mt-2">
                                                                ...
                                                                <h5 id="page-path"><a onclick="jumpToPage('null')">My
                                                                        Files /</a></h5>
                                                                <button class="btn border border-1 mb-2"
                                                                    id="previous-page-button"
                                                                    onclick="getOutsideFolder(getOutsideFolder)">&lt;
                                                                </button>
                                                                <button class="btn border border-1 mb-2" disabled="true"
                                                ...
                                                <div>
                                                    <div class="row" id="docs" style="min-height: 400px;">
                                                ...
                                                <div class="mt-4">
                                                    <div class="d-flex flex-wrap">
                                                        ...
                                                        <div class="ms-auto">
                                                            <a href="javascript: void(0);"
                                                                class="fw-medium text-reset">View
                                                                All</a>
                                                        </div>
                                                    </div>
                                                    <hr class="mt-2">
