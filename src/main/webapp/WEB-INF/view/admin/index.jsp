...
<body data-sidebar="dark">
											...
											<div class="pt-4">
												...
												<div class="mt-4">
													<a href="javascript: void(0);"
														...
														Profile <i class="mdi mdi-arrow-right ms-1"></i>
													</a>
												</div>
											</div>
										</div>
								...
								<div class="card-body">
									...
									<div class="row">
										<div class="col-sm-6">
											...
											<h3>$34,252</h3>
											<p class="text-muted">
												<span class="text-success me-2"> 12% <i
									...
									<p class="text-muted mb-0">We craft digital, graphic and
										dimensional thinking.</p>
								</div>
							</div>
						</div>
						<div class="col-xl-8">
												...
												<div class="flex-shrink-0 align-self-center">
													<div
														...
														<span class="avatar-title"> <i
															class="fas fa-user font-size-20"></i>
														</span>
													</div>
												</div>
											</div>
								...
								<div class="col-md-4">
									<div class="card mini-stats-wid">
										<div class="card-body">
											<div class="d-flex">
												<div class="flex-grow-1">
													<p class="text-muted fw-medium">Total Usage</p>
													<h4 class="mb-0" id="total-usage">
														<div class="spinner-border text-primary m-1" role="status">
															<span class="sr-only">Loading...</span>
														</div>
													</h4>
								...
								<div class="col-md-4">
									<div class="card mini-stats-wid">
										<div class="card-body">
											<div class="d-flex">
												<div class="flex-grow-1">
													<p class="text-muted fw-medium">Average Usage</p>
													<h4 class="mb-0" id="average-usage">
														<div class="spinner-border text-primary m-1" role="status">
															<span class="sr-only">Loading...</span>
														</div>
													</h4>
							...
							<div class="card">
								<div class="card-body">
									<div class="d-sm-flex flex-wrap">
										<h4 class="card-title mb-4">User Usage</h4>
										<div class="ms-auto">
											<ul class="nav nav-pills">
												<li class="nav-item"><a class="nav-link" href="#">Week</a>
												</li>
												<li class="nav-item"><a class="nav-link" href="#">Month</a>
												</li>
									...
									<div
										class="col-md-12 border-right border-bottom d-flex justify-content-center align-items-center"
										style="min-height: 475px" id="container">
										<div class="spinner-border text-primary m-1" role="status">
											<span class="sr-only">Loading...</span>
										</div>
								...
								<div class="card-body">
									...
									<div class="text-center">
										<div class="avatar-sm mx-auto mb-4">
											<span
												class="avatar-title rounded-circle bg-primary-subtle font-size-24">
												<i class="mdi mdi-facebook text-primary"></i>
											</span>
										</div>
										<p class="font-16 text-muted mb-2"></p>
										<h5>
											<a href="javascript: void(0);" class="text-dark">Facebook
										...
										<p class="text-muted">Maecenas nec odio et ante tincidunt
											...
											tincidunt.</p>
										<a href="javascript: void(0);" class="text-primary font-16">Learn
													...
													<th style="width: 20px">
														<div class="form-check font-size-16 align-middle">
															<input class="form-check-input" type="checkbox"
																id="transactionCheck01" /> <label
																class="form-check-label" for="transactionCheck01"></label>
														</div>
													</th>
											...
											<tbody>
												<tr>
													<td>
														<div class="form-check font-size-16">
															<input class="form-check-input" type="checkbox"
																id="transactionCheck02" /> <label
																class="form-check-label" for="transactionCheck02"></label>
														</div>
													</td>
													...
													<td><i class="fab fa-cc-mastercard me-1"></i>
														Mastercard</td>
													<td>
														...
														<button type="button"
															...
															data-bs-target=".transaction-detailModal">View
															Details</button>
													</td>
												</tr>
												...
												<tr>
													<td>
														<div class="form-check font-size-16">
															<input class="form-check-input" type="checkbox"
																id="transactionCheck03" /> <label
																class="form-check-label" for="transactionCheck03"></label>
														</div>
													</td>
													<td><a href="javascript: void(0);"
												...
												<tr>
													<td>
														<div class="form-check font-size-16">
															<input class="form-check-input" type="checkbox"
																id="transactionCheck04" /> <label
																class="form-check-label" for="transactionCheck04"></label>
														</div>
													</td>
													<td><a href="javascript: void(0);"
												...
												<tr>
													<td>
														<div class="form-check font-size-16">
															<input class="form-check-input" type="checkbox"
																id="transactionCheck05" /> <label
																class="form-check-label" for="transactionCheck05"></label>
														</div>
													</td>
													<td><a href="javascript: void(0);"
												...
												<tr>
													<td>
														<div class="form-check font-size-16">
															<input class="form-check-input" type="checkbox"
																id="transactionCheck06" /> <label
																class="form-check-label" for="transactionCheck06"></label>
														</div>
													</td>
													<td><a href="javascript: void(0);"
												...
												<tr>
													<td>
														<div class="form-check font-size-16">
															<input class="form-check-input" type="checkbox"
																id="transactionCheck07" /> <label
																class="form-check-label" for="transactionCheck07"></label>
														</div>
													</td>
													<td><a href="javascript: void(0);"
	...
	<!-- high chart js -->
	<script
		src="<%=request.getContextPath()%>/adminResource/js/highcharts.js"></script>
	<!-- custom admin dashboard js -->
	<script
		src="<%=request.getContextPath()%>/adminResource/js/custom/admin/adminDashboard.js"></script>
</body>
